    ...
    if zip_select != 'Zip':
        ...
        if rank_select:
            ...
            with tab3:
                ...
                st.divider()
                col1,col2=st.columns(2)            
                col1.metric('Pct Single Family Residential','{:.1%}'.format(selected_record['PCT_UNIT1'][0].round(2)/100),delta=selected_record['PCT_UNIT1_Q'][0],delta_color='off')
            ...
            with tab5:
                ...
                st.divider()
                col1,col2=st.columns(2)   
                col1.metric('Population Density','{:,}'.format(selected_record['POP_DENSITY'][0].round(2)),delta=selected_record['POP_DENSITY_Q'][0],delta_color='off')
                col2.metric('Population Density','{:,}'.format(compare_record['POP_DENSITY'][0].round(2)),delta='{:.0f}'.format(dif_record['POP_DENSITY'][0]))
                st.divider()
                col1,col2=st.columns(2)  
