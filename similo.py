    ...
    if zip_select != 'Zip':
        ...
        if rank_select:
            ...
            with tab2:
                ...
                col1.metric('Median Age',selected_record['MED_AGE'][0].round(2),delta=selected_record['MED_AGE_Q'][0],delta_color='off')
                col2.metric('Median Age',compare_record['MED_AGE'][0].round(2),delta=dif_record['MED_AGE'][0].round(2))
                col1.metric('Median Household Income','${:,.0f}'.format(selected_record['MED_HH_INC'][0].round(2)),delta=selected_record['MED_HH_INC_Q'][0],delta_color='off')
                ...
                col1.metric('Percent in Poverty','{:.1%}'.format(selected_record['PCT_POVERTY'][0].round(2)/100),delta=selected_record['PCT_POVERTY_Q'][0],delta_color='off')
                ...
                col1.metric('Percent with Bachelors Degree or More','{:.1%}'.format(selected_record['PCT_BACH_MORE'][0].round(2)/100),delta=selected_record['PCT_BACH_MORE_Q'][0],delta_color='off')
            ...
            with tab3:
                ...
                col1.metric('Avg HH Size','{:,.1f}'.format(selected_record['HH_SIZE'][0].round(2)),delta=selected_record['HH_SIZE_Q'][0],delta_color='off')
                col2.metric('Avg HH Size','{:,.1f}'.format(compare_record['HH_SIZE'][0].round(2)),delta='{:,.1f}'.format(dif_record['HH_SIZE'][0].round(2)))
                        
                col1.metric('Avg Family Size','{:,.1f}'.format(selected_record['FAM_SIZE'][0].round(2)),delta=selected_record['FAM_SIZE_Q'][0],delta_color='off')
                col2.metric('Avg Family Size','{:,.1f}'.format(compare_record['FAM_SIZE'][0].round(2)),delta='{:,.1f}'.format(dif_record['FAM_SIZE'][0].round(2)))
                        
                col1.metric('Median Home Price','${:,.0f}'.format(selected_record['MED_HOME'][0].round(2)),delta=selected_record['MED_HOME_Q'][0],delta_color='off')
                col2.metric('Median Home Price','${:,.0f}'.format(compare_record['MED_HOME'][0].round(2)),delta='${:,.0f}'.format(dif_record['MED_HOME'][0].round(2)))
                            
                col1.metric('Median Rent Price','${:,.0f}'.format(selected_record['MED_RENT'][0].round(2)),delta=selected_record['MED_RENT_Q'][0],delta_color='off')
                col2.metric('Median Rent Price','${:,.0f}'.format(compare_record['MED_RENT'][0].round(2)),delta='${:,.0f}'.format(dif_record['MED_RENT'][0].round(2)))
                            
                col1.metric('Pct 1-unit Property','{:.1%}'.format(selected_record['PCT_UNIT1'][0].round(2)/100),delta=selected_record['PCT_UNIT1_Q'][0],delta_color='off')
                col2.metric('Pct 1-unit Property','{:.1%}'.format(compare_record['PCT_UNIT1'][0].round(2)/100),delta='{:.1%}'.format(dif_record['PCT_UNIT1'][0].round(2)/100))
            with tab4:
                col1,col2=st.columns(2)
                col1.subheader('Selected')
                col1.write(selected_zip+' '+selected_county)
                ...
                col1.metric('Pct Working','{:.1%}'.format(selected_record['PCT_WORKING'][0].round(2)/100),delta=selected_record['PCT_WORKING_Q'][0],delta_color='off')
                col2.metric('Pct Working','{:.1%}'.format(compare_record['PCT_WORKING'][0].round(2)/100),delta='{:.1%}'.format(dif_record['PCT_WORKING'][0]/100))

                col1.metric('Avg Commute Time',selected_record['MEAN_COMMUTE'][0].round(2),delta=selected_record['MEAN_COMMUTE_Q'][0],delta_color='off')
            ...
            with tab5:
                ...
                st.divider()
                col1,col2=st.columns(2)
                col1.write('Metropolitan Index')
                col1.write(selected_record['Metropolitan'][0])
                col2.write('Metropolitan Index')
                col2.write(compare_record['Metropolitan'][0])

                col1.metric('Population Density','{:.0f}'.format(selected_record['POP_DENSITY'][0].round(2)),delta=selected_record['POP_DENSITY_Q'][0],delta_color='off')
                col2.metric('Population Density','{:.0f}'.format(compare_record['POP_DENSITY'][0].round(2)),delta='{:.0f}'.format(dif_record['POP_DENSITY'][0]))

                col1.metric('Pct Area is Water','{:.2%}'.format(selected_record['Pct_Water'][0]),delta=selected_record['Pct_Water_Q'][0],delta_color='off')
                col2.metric('Pct Area is Water','{:.2%}'.format(compare_record['Pct_Water'][0]),delta='{:.2%}'.format(dif_record['Pct_Water'][0]))

                col1.metric('Environmental Quality Index','{:.2f}'.format(selected_record['Env_Index'][0].round(2)),delta=selected_record['Env_Index_Q'][0],delta_color='off')
                ...
                col1.metric('Pct within 0.5 mile to Park','{:.1%}'.format(selected_record['Pct_ToPark_HalfMile'][0].round(2)/100),delta=selected_record['Pct_ToPark_HalfMile_Q'][0],delta_color='off')
                ...
                col1.metric('Pct within 1 mile to Park','{:.1%}'.format(selected_record['Pct_ToPark_OneMile'][0].round(2)/100),delta=selected_record['Pct_ToPark_OneMile_Q'][0],delta_color='off')
