...
if selected=="Search":
    ...
    with st.expander('Advanced Settings'):
        ...
        st.caption('Default = 1.0')
        st.caption('Move the slider higher or lower for each category where lower values mean lower importance and higher values mean higher importance')
